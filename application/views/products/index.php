                    ...
                    <div class="right-action text-right">
                        <div class="btn-groups">
                            <div class="col-md-5" style="line-height: 50px;">
                                <form action="product/upload_excel"
                            ...
                            <div class="col-md-7">
                                <a class="btn btn-primary"
                                   href="public/templates/product.xlsx">Tải file mẫu</a>
                                <a class="btn btn-primary"
                                   href="product/cms_export_excel2/"> Báo giá sỉ</a>
                                <a class="btn btn-primary"
                                   href="product/cms_export_excel/"> Báo giá lẻ</a>
                                <a class="btn btn-primary"
