    ...
    <?php if (isset($_list_inputs) && count($_list_inputs)) :
        ...
        foreach ($_list_inputs as $key => $item) :
            ...
            <tr class="input_debt" data-id="<?php echo $item['ID'];?>">
                ...
                <td class="text-center input_lack" style="background: #fff;"><?php echo cms_encode_currency_format($item['lack']); ?></td>
                <td class="text-center"><input id="payment_money-<?php echo $item['ID']; ?>" class="payment_money form-control txtMoney" type="text" placeholder="Số tiền chi""></td>
