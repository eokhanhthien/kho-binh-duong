...
<script type="text/javascript">
    $('#payment_tongtien').html('<?php echo cms_encode_currency_format((isset($total_orders['total_money']) ? $total_orders['total_money'] : 0)); ?>');
    $('#payment_sodon').html('<?php echo (isset($total_orders['quantity'])) ? $total_orders['quantity'] : 0; ?>');
    $('#payment_datt').html('<?php echo cms_encode_currency_format((isset($total_orders['total_money']) ? $total_orders['total_money']-$total_orders['total_debt'] : 0)); ?>');
    $('#payment_conno').html('<?php echo cms_encode_currency_format((isset($total_orders['total_debt']) ? $total_orders['total_debt'] : 0)); ?>');
</script>