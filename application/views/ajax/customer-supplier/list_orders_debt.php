    ...
    <?php if (isset($_list_orders) && count($_list_orders)) :
        foreach ($_list_orders as $key => $item) :
            ...
            <tr class="order_debt" data-id="<?php echo $item['ID'];?>">
                ...
                <td class="text-center order_lack" style="background: #fff;"><?php echo cms_encode_currency_format($item['lack']); ?></td>
                <td class="text-center"><input id="receipt_money-<?php echo $item['ID']; ?>" class="receipt_money form-control txtMoney" type="text" placeholder="Số tiền thu""></td>
