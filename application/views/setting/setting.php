                                ...
                                foreach ($_user as $key => $val) : $ind++; ?>
                                    <tr class="tr-item-<?php echo $val['id']; ?>">
                                        ...
                                        <td class="text-center">
                                            <i class="fa fa-pencil-square-o edit-item" title="Sửa"
                                            ...
                                            <?php 
                                               ...
                                               <i
                                                ...
                                                class="fa fa-trash-o delete-item" style="cursor: pointer;"></i>
                                            <?php }else{
                                                echo '<i></i>';
                                            } ?>
                                            </td>
                                    ...
                                    <tr class="edit-tr-item-<?php echo $val['id']; ?>" style="display: none;">
                                        ...
                                        <td class="itgroup_name">
                                            <div class="group-user">
                                             ...
                                             <input type="password" id="newpassword" placeholder="Reset mật khẩu mới cho nhân viên" class="form-control"
                                                                   value=""/>
                                        </td>
            ...
            <div class="col-sm-12 no-padding">
                ...
                <div class="col-sm-6 no-padding-right">
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div id="review_template" style="min-height:440px; height: auto;padding-left:5px;padding-right:5px"
                                 compile="printHtml">
