<div class="sidebar sidebar-fixed hidden-xs hidden-sm hidden-md" id="sidebar">
    <ul class="nav nav-pills nav-list nav-stacked">
        ...
        <?php if (in_array(4, $user['group_permission'])) : ?>
            <li id="customer"><a href="customer"><i class="fa fa-users"></i>Khách hàng - NCC</a></li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if (in_array(20, $user['group_permission'])) : ?>
            <li id="cashbook"><a href="cashbook"><i class="fa fa-cogs"></i>Sổ quỹ</a></li>
        <?php endif; ?>
        <?php if (in_array(10, $user['group_permission'])) : ?>
            <li id="profit"><a href="profit"><i class="fa fa-usd"></i>Lợi nhuận</a></li>
        <?php endif; ?>
        <?php if (in_array(10, $user['group_permission'])) : ?>
            <li id="payroll"><a href="payroll"><i class="fa fa-usd"></i>Bảng lương</a></li>
        <?php endif; ?>
