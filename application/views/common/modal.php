            ...
            <div class="modal-body">
                <div class="form-horizontal" id="frm-crcust">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="is_customer_debt" name="is_customer_debt" class="txtMoney form-control" value=""
            ...
            <div class="modal-body">
                <div class="form-horizontal" id="frm-crsup">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="is_supplier_debt" name="is_supplier_debt" class="form-control txtMoney" value=""
