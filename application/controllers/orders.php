...
class Orders extends CI_Controller
{
    ...
    public function cms_print_order()
    {
        ...
        $data_template['content'] = str_replace("{Kho_Hang}", cms_getNamestockbyID($data_order['store_id']), $data_template['content']);
        ...
        $data_template['content'] = str_replace("{Chi_Tiet_San_Pham2}", $table, $data_template['content']);
    ...
    public function cms_autocomplete_products($customer_id=0)
    {
        ...
        if (isset($product) && count($product) != 0) {
            ...
            <tr data-id="<?php echo $product['ID']; ?>">
                ...
                <td class="text-center" style="max-width: 30px;"><input style="min-width:80px;max-height: 22px;"
                                                                        type="text"
                                                                        class="form-control quantity_product_order text-center"
                                                                        value="1"></td>
